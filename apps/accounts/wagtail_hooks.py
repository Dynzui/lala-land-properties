...
def register_owner_admin_urls():
    return [
        ...
        path("staff-management/<uuid:user_id>/<str:action>/", staff_action, name="lala_staff_action"),
        path("staff-management/invitations/<uuid:invitation_id>/revoke/", revoke_invitation, name="lala_revoke_invitation"),
...
def register_staff_menu():
    return OwnerMenuItem("Staff management", reverse("lala_staff_dashboard"), icon_name="group", order=800)
